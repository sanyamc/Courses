...
5. TotalSO2 has somewhat varied distribution throughout quality. And gives a sense of somewhat normal distribution, which suggests that if TotalSO2 is low(around the mean of quality 4 and 8) we can predict the quality of Wine with higher probability.
...
Strongest relation I found was between pH and fixed.Acidity. I also found strong relation between Density and fixed acidity which I wasn't expecting. Again relationship between density and fixed acidity is counterintuitive. As density represents water density and should have theoretically should have inverse relation with amount of acid in the wine.
