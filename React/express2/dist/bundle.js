...
/***/ function(module, exports, __webpack_require__) {
	...
	const react_redux_1 = __webpack_require__(168);
	const redux_1 = __webpack_require__(175);
	//import App from './components/app';
	//import reducers from './reducers';
	const createStoreWithMiddleware = redux_1.applyMiddleware()(redux_1.createStore);
	ReactDOM.render(React.createElement(react_redux_1.Provider, {store: createStoreWithMiddleware(reducers)}, React.createElement("div", null, "Hello from React!")), document.querySelector('.container'));
